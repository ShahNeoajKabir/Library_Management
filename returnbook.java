...
PreparedStatement pst;
    ...
    public void ReturnUpdate(){
        String sql="insert into return_book(Student_Id,Book_Name,Publisher,Price,Quantity,Student_Name,Book_Id) values(?,?,?,?,?,?,?)";
         try{
            pst=con.prepareStatement(sql);
          pst.setString(1, idTextField.getText());
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Return Book", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 3, 18), new java.awt.Color(0, 204, 204))); // NOI18N
        ...
        returnButton.setBackground(new java.awt.Color(51, 0, 0));
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                ...
                nameTextField.setText(b);
                String c=rs.getString("Publisher");
               publisherTextField.setText(c);
                String d=rs.getString("Price");
                priceTextField.setText(d);
                 String e=rs.getString("Quantity");
                 quantityTextField.setText(e);
                 String f=rs.getString("Student_Name");
                name.setText(f);
                rs.close();
                pst.close();
            }
